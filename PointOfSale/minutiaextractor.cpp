    ...
    for (int i = 0; i < (int)filteredMinutiae.size(); i++)
    {
        ...
        for (int j = 0; j < (int)filteredMinutiae.size(); j++)
        {
            if (i != j)
            {
                 ...
                 */
                if (mA.type == End && fmin(Angle::differencePi(mA.angle, angleOI), Angle::differencePi(mA.angle, angleOI + M_PI)) > M_PI / 6) {
                    toErase[i] = TRUE;
                }
                 ...
                 */
                if (mA.type == mB.type && euclideanDistance(mA, mB) < 5)    {
                 ...
                 */
                if (mA.type == End && mB.type == End && mA.angle == mB.angle && euclideanDistance(mA, mB) < 10) {
                    toErase[i] = toErase[j] = TRUE;
                }
                 ...
                 */
                if (mA.type == End && mB.type == End && Angle::differencePi(mA.angle, mB.angle) < M_PI / 12 && euclideanDistance(mA, mB) < 10)   {
                    toErase[i] = toErase[j] = TRUE;
                }
            }
