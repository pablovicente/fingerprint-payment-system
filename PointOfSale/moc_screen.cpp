...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Screen_t, stringdata) + ofs \
...
const QMetaObject Screen::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Screen.data,
...
void *Screen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Screen.stringdata))
